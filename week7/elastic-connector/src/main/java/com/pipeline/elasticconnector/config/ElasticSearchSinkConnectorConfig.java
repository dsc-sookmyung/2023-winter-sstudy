package com.pipeline.elasticconnector.config;
...
public class ElasticSearchSinkConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef CONFIG = new ConfigDef().define(ES_CLUSTER_HOST, Type.STRING, ES_CLUSTER_HOST_DEFAULT_VALUE,
            Importance.HIGH, ES_CLUSTER_HOST_DOC)
